        ...
        <div class="products flex">
            ...
            <div class="w-4/5 pl-10 mr-10">
                ...
                <div class="relative mb-8">
                    ...
                    <!-- SEARCH INPUT -->
                    <vs-input class="w-full vs-input-shadow-drop vs-input-no-border d-theme-input-dark-bg" placeholder="Search here" v-model="searchQuery" size="large" />
                    ...
                    <!-- CLEAR INPUT ICON -->
                    <div slot="reset-icon" class="absolute top-0 right-0 py-4 px-6" v-show="searchQuery">
                ...
                <div class="items-grid-view vx-row match-height" appear>
                    <div class="vx-col lg:w-1/4 md:w-1/3 sm:w-1/2 w-full" v-for="item in products" :key="item.id">
